  ...
  await wh.send({
    ...
    components: [{
      ...
      components: [
        ...
        { type: 14, spacing: 1, divider: true },
        { type: 1, components: [
          { type: 2, style: 4, emoji: { name: '🚫' }, custom_id: `log_ban:${m.author.id}` },
          { type: 2, style: 4, emoji: { name: '🛑' }, custom_id: `log_bl:${m.author.id}` },
          { type: 2, style: 2, emoji: { name: '♻️' }, custom_id: `log_unbl:${m.author.id}` },
          { type: 2, style: 1, emoji: { name: '🧾' }, custom_id: `log_copy:${logId}` },
        ]},
      ],
    }],
